...
**使用后下一步**：进入新项目，准备 `docs/vision/` 或 `docs/inputs/` 上游输入，补 `docs/env/local-env.md` 人工确认项，再用 `ai/prompts/docs/01-review-inputs.md` 评审输入材料并用 `ai/prompts/docs/00-generate-or-complete-docs.md` 生成 / 补齐 docs 文档体系。
